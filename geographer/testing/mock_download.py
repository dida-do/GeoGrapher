"""Mock rstools S2 associator for testing the download function.
...
# from rstools.rsassoc import raster_imgs_from_s2_tif_dir as raster_imgs_from_dir
...
# 
OBJECT_TYPES = ['ct', 'ht' ,'pt', 'it', 'rt', 'dt', 'ts', 'wr', 'h'] 
...
POLYGONS_DF_COLS_AND_TYPES = {'geometry': shapely.geometry, 
                                        ...
                                        **{f"prob_seg_class_{seg_class}": float for seg_class in OBJECT_TYPES},
                                        'visibility': int,
                                        'date': str}
POLYGONS_DF_COLS_AND_INDEX_TYPES = {**POLYGONS_DF_INDEX_NAME_AND_TYPE, **POLYGONS_DF_COLS_AND_TYPES}
"""

from rstools.rsassoc.img_polygon_associator_rstools_s2 import LABEL_TYPE
