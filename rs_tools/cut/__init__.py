...
from rs_tools.cut.cut_dataset_iter_over_polygons import new_dataset_one_small_img_for_each_polygon
from rs_tools.cut.cut_dataset_iter_over_polygons import update_dataset_one_small_img_for_each_polygon
from rs_tools.cut.cut_dataset_iter_over_polygons import create_or_update_dataset_from_iter_over_polygons