...
class JAXADownloaderMixIn(object):
    ...
    def _download_imgs_for_polygon_jaxa(
            ...
            jaxa_data_version : Optional[str] = None,
            **kwargs):
        """
        ...
        if jaxa_data_version is None:
            try:
                # Use saved value
                value = getattr(self, 'jaxa_data_version')
            except AttributeError:
                raise ValueError("Need to set jaxa_data_version keyword argument ('1804', '1903', '2003', or '2012').")
        else:
            # Remember value
            setattr(self, 'jaxa_data_version', jaxa_data_version)
