class BipartiteGraphClass:
    """
    Abstract class for bipartite graphs (the decomposition of a vertex set into two sets are thought of as vertex colors, e.g. red or black) which can be serialized in/read in from a json file. The graph can be directed or not and the edges can have extra data. e.g. a name, a color, a weight, possibly even composite data in the form of tuples.
    """
