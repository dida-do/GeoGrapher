...
from aubesa.utils import create_logger
...
def safe_to_geotif_L2A(
        ...
        upsampling_method_specifier: str = "bilinear") -> Tuple[Dict, Dict]:
    """
    ...
    # # if we have both B08 and B8A remove B8A
    # if 'B08' in bands_dict and 'B8A' in bands_dict:
    #     band,_ = bands_dict.pop('B8A')
    #     band.close()
