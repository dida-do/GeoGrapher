...
def test_bipartite_graph():
    ...
    assert graph1._graph_dict == {'red': {'r3': {'b1': "bar"}, 
                                            'r2': {}, 
                                            'r1': {'b1': "foo", 'b2': "foo"}},
                                    'black': {'b3': {}, 
                                            'b2': {'r1': "foo"}, 
    ...
    with pytest.raises(Exception):
        graph1.add_edge('r1', 'red', 'b1', "foo") # edge was in edges_with_existing_vertices 
    ...
    assert graph1._graph_dict == {'red': {'r3': {'b1': "bar", 'b6': "bar"},
                                            'r2': {},
    ...
    assert graph1._graph_dict == {'red': {'r3': {'b1': "foo", 'b6': "bar"},
                                            'r2': {},
                                            'r1': {'b1': "foo", 'b2': "foo", 'b4': "foo", 'b5': "foo"},
                                            'r4': {'b4': "foo"},
                                            'r5': {'b4': "foo"},
    ...
    assert set(graph1.vertices_opposite('b4', 'black', edge_data="foo")) == set({'r4', 'r5'})
    ...
    assert graph1._graph_dict == {'red': {'r3': {'b1': "foo"}, 
                                            'r2': {}, 
                                            'r1': {'b1': "foo", 'b2': "foo"}},
                                    'black': {'b3': {}, 
                                            'b2': {'r1': "foo"}, 
    ...
    assert graph1._graph_dict == {'red': {'r3': {}, 
                                            'r2': {}, 
                                            'r1': {'b1': "foo", 'b2': "foo"}},
                                    'black': {'b3': {}, 
                                            'b2': {'r1': "foo"}, 
