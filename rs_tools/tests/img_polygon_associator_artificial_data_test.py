...
Simple pytest test suite of rstoolsImgPolygonAssociator using artificial data (i.e. we write a polygons_df and an img_data by hand and don't test any methods (e.g. add/download missing images, create labels) that deal with the actual images.)
