...
Test get_cutter_every_img_to_grid from geographer.cutters.cut_every_img_to_grid.
...
def test_cut_every_img_to_grid(dummy_cut_source_data_dir):
    ...
    tempelhofer_feld_geom = target_connector.vector_features.loc[
        "berlin_tempelhofer_feld"
    ].geometry
    intersecting_geoms = target_connector.raster_imgs.loc[
