...
Test get_cutter_imgs_around_every_feature from
geographer.cutters.cut_imgs_around_every_feature.
...
def test_imgs_around_every_feature():
    ...
    tempelhofer_feld: Polygon = target_connector.vector_features.loc[
        "berlin_tempelhofer_feld"
    ].geometry
    imgs_intersecting_tempelhofer_feld: List[
        str
    ] = target_connector.imgs_intersecting_vector_feature("berlin_tempelhofer_feld")
    bboxes = target_connector.raster_imgs.geometry.loc[
        imgs_intersecting_tempelhofer_feld
    ].tolist()
